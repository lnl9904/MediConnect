        ...
        <div className="App">
          <Routes>
            ...
            <Route path="/" element={
              <>
                <Header />
                <main><div className="container"><HomePage /></div></main>
                <Footer />
              </>
            } />
            <Route path="/login" element={
              <>
                <Header />
                <main><div className="container"><Login /></div></main>
                <Footer />
              </>
            } />
            <Route path="/register" element={
              <>
                <Header />
                <main><div className="container"><Register /></div></main>
                <Footer />
              </>
            } />
            ...
            <Route element={<ProtectedRoute requiredRoles={["doctor"]} />}>
              <Route path="/doctor/dashboard" element={
                <>
                  <Header />
                  <main><div className="container"><DoctorDashboard /></div></main>
                  <Footer />
                </>
              } />
              <Route path="/doctor/profile" element={
                <>
                  <Header />
                  <main><div className="container"><DoctorProfile /></div></main>
                  <Footer />
                </>
              } />
              <Route path="/doctor/appointments" element={
                <>
                  <Header />
                  <main><div className="container"><DoctorAppointments /></div></main>
                  <Footer />
                </>
              } />
              <Route path="/doctor/notifications" element={
                <>
                  <Header />
                  <main><div className="container"><DoctorNotifications /></div></main>
                  <Footer />
                </>
              } />
            </Route>
            ...
            <Route path="/doctors" element={
              <>
                <Header />
                <main><div className="container"><AllDoctorsPage /></div></main>
                <Footer />
              </>
            } />
            <Route path="/doctor/:id" element={
              <>
                <Header />
                <main><div className="container"><DoctorDetailPage /></div></main>
                <Footer />
              </>
            } />
            <Route path="/confirm-appointment" element={
              <>
                <Header />
                <main><div className="container"><ConfirmAppointmentPage /></div></main>
                <Footer />
              </>
            } />
            <Route path="/specialty/:id" element={
              <>
                <Header />
                <main><div className="container"><SpecialtyDetailPage /></div></main>
                <Footer />
              </>
            } />
